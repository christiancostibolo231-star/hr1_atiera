...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 11, 2026 at 11:24 AM
...
(23, 504, 1, 'Front Desk Officer', 'Handles guest check-ins, reservations, and inquiries.', 'Excellent communication skills and experience with hotel software.', 1, 0, 'Open', '2025-10-24 08:43:24', '2026-01-11 08:33:13', 'Full-time'),
...
CREATE TABLE `login_accounts` (
  ...
  `account_type` enum('admin','employee','public') DEFAULT 'public',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `login_accounts` (`id`, `email`, `password_hash`, `account_type`, `created_at`) VALUES
(2, 'admin@hr1.com', '$2y$10$REPLACE_WITH_ADMIN_HASH', 'admin', '2026-01-11 06:58:18'),
(3, 'employee@hr1.com', '$2y$10$REPLACE_WITH_EMPLOYEE_HASH', 'employee', '2026-01-11 06:58:18'),
(4, 'user@hr1.com', '$2y$10$REPLACE_WITH_USER_HASH', 'public', '2026-01-11 06:58:18');
