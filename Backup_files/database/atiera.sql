...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 19, 2025 at 11:51 PM
...
INSERT INTO `applicants` (`applicant_id`, `first_name`, `middlename`, `last_name`, `email`, `phone`, `resume_path`, `application_date`, `status`, `job_id`, `address`, `birthdate`, `gender`, `photo_path`) VALUES
(1, 'James Ryan', 'Ortega', 'Vergara', 'james@email.com', '09944967965', 'uploads/1757977880_HR1 SYSTEM PROCESS.pdf', '2025-09-15', '', 1, 'BLK 166 lot 4 ST.Cecilia Deca Homes,Loma de Gato, Marilao, Bulacan', '2002-03-17', 'Male', NULL),
(2, 'James', 'Dontknow', 'Sabandal', 'test@email.com', '1231231231', 'uploads/1757981011_HR1 SYSTEM PROCESS.pdf', '2025-09-15', 'In Progress', 1, 'BLK 160 lot 100 ST.Cecilia Deca Homes,Loma de Gato, Marilao, Bulacan', '2001-01-02', 'Male', NULL),
(17, 'Angelo', 'Evangelista', 'Revilla', 'angelo@hr1.com', '09123456789', 'uploads/1760411312_Untitled design.pdf', '2025-10-13', '', 5, 'blk 150 Lot 19 St.Cecilia deca homes Loma de Gato, Marilao, Bulacan', NULL, NULL, 'uploads/captured_1760411312.png'),
(18, 'Alex', 'Ortegara', 'Vergara', 'alex@hr1.com', '09123456789', 'uploads/1760599648_Untitled design.pdf', '2025-10-15', '', 3, 'BLK 166 lot 4 ST.Cecilia Deca Homes,Loma de Gato, Marilao, Bulacan', NULL, NULL, 'uploads/captured_1760599648.png');
...
INSERT INTO `applicant_profile` (`applicant_id`, `user_id`, `first_name`, `middlename`, `last_name`, `email`, `phone`, `resume_path`, `application_date`, `status`, `job_id`, `address`, `birthdate`, `gender`, `photo_path`) VALUES
(1, NULL, 'James Ryan', 'Ortega', 'Vergara', 'james@email.com', '09944967965', 'uploads/1757977880_HR1 SYSTEM PROCESS.pdf', '2025-09-15', 'In Progress', NULL, 'BLK 166 lot 4 ST.Cecilia Deca Homes, Loma de Gato, ...', '2002-03-17', 'Male', NULL),
(2, NULL, 'James', 'De Leon', 'Sabandal', 'test@email.com', '1231231231', 'uploads/1757981011_HR1 SYSTEM PROCESS.pdf', '2025-09-15', 'In Progress', NULL, 'BLK 160 lot 100 ST.Cecilia Deca Homes, Loma de Gato...', '2001-01-02', 'Male', '<br /><b>Deprecated</b>:  htmlspecialchars(): Passing null to parameter #1 ($string) of type string is deprecated in <b>C:\\xampp\\htdocs\\Atiera\\admin\\applicant_profile.php</b> on line <b>155</b><br />');
...
INSERT INTO `applicant_profiles` (`id`, `user_id`, `firstname`, `middlename`, `lastname`, `address`, `contact`, `picture`, `resume`, `created_at`) VALUES
(2, 4, 'Christian', 'Candido', 'Costibolo', 'blk 170 Lot 9 St.Cecilia deca homes Loma de Gato, Marilao, Bulacan', '09123456789', 'uploads/captured_1760407985.png', 'uploads/1760408299_Untitled design.pdf', '2025-10-14 02:13:05'),
(3, 5, 'Angelo', 'Evangelista', 'Revilla', 'blk 150 Lot 19 St.Cecilia deca homes Loma de Gato, Marilao, Bulacan', '09123456789', 'uploads/captured_1760411312.png', 'uploads/1760411312_Untitled design.pdf', '2025-10-14 03:08:32'),
(4, 6, 'Alex', 'Ortegara', 'Vergara', 'BLK 166 lot 4 ST.Cecilia Deca Homes,Loma de Gato, Marilao, Bulacan', '09123456789', 'uploads/captured_1760599648.png', 'uploads/1760599648_Untitled design.pdf', '2025-10-16 07:27:28');
...
(3, 4, NULL, '2025-10-29 08:30:00', 'Pending', NULL, '2025-09-17 01:27:16', '2025-10-10 08:42:19');
...
(1, 'HR Specialist', 1, 'We are seeking a knowledgeable, organized, and proactive HR Specialist to join our Human Resources team. The HR Specialist will support various HR functions, including recruitment, employee relations, benefits administration, compliance, and training. This role plays a key part in ensuring HR operations run smoothly and align with company policies and labor regulations.', 'Full-time', NULL, 'Open', 5, 0, '2025-09-14 05:05:49'),
(2, 'Cashier', 2, 'We are seeking a friendly, reliable, and detail-oriented Cashier to join our team. The ideal candidate will provide excellent customer service while efficiently handling cash, credit, and other forms of payment. As a cashier, you play a key role in creating a positive shopping experience for our customers through accuracy, professionalism, and a helpful attitude.', 'Full-time', 1, 'Closed', 0, 0, '2025-09-15 20:47:13'),
(3, 'Waiter', 1, 'We are looking for a courteous, attentive, and customer-focused Waiter/Waitress to join our front-of-house team. The ideal candidate will have a passion for hospitality and be dedicated to delivering excellent service in a fast-paced environment. You will be responsible for taking orders, serving food and beverages, and ensuring guest satisfaction throughout their dining experience', 'Full-time', 1, 'Open', 5, 0, '2025-09-15 20:51:28'),
(4, 'Janitor', 1, 'We are seeking a reliable and detail-oriented Janitor to join our facilities team. The successful candidate will be responsible for maintaining a clean, safe, and sanitary environment in all areas of the building, including offices, restrooms, common areas, and other facilities. This role is essential in ensuring a welcoming and hygienic space for staff, visitors, and clients.', 'Full-time', 1, 'Closed', 10, 0, '2025-09-15 21:57:56'),
(5, 'Department Manager', 1, 'About Us:\r\nWe are a leading hotel and restaurant group dedicated to delivering exceptional guest experiences. With a culture built on teamwork, innovation, and integrity, we pride ourselves on creating an environment where both our employees and guests thrive.\r\n\r\nResponsibilities:\r\nOversee daily operations to ensure efficiency and high service standards.\r\n\r\nLead, mentor, and develop a team of department staff.\r\n\r\nManage budgets, financial reports, and performance metrics.\r\n\r\nCoordinate with other departments to ensure smooth workflow and guest satisfaction.\r\n\r\nHandle customer concerns and resolve issues in a professional manner.\r\n\r\nQualifications:\r\nBachelor’s degree in Business Administration, Hospitality Management, or a related field.\r\n\r\n5+ years of management experience, preferably in the hotel or restaurant industry.\r\n\r\nStrong leadership, organizational, and communication skills.\r\n\r\nAbility to manage multiple priorities in a fast-paced environment.\r\n\r\nProficiency in MS Office and basic financial management.\r\n\r\nBenefits:\r\nCompetitive salary and performance-based bonuses.\r\n\r\nHealth and wellness benefits package.\r\n\r\nEmployee discounts on hotel and restaurant services.\r\n\r\nOpportunities for career growth and professional development.\r\n\r\nPaid vacation and holidays.\r\n\r\nHow to Apply:\r\nInterested candidates should click the Apply Now button to complete the application form and upload their resume.', 'Full-time', 1, 'Open', 10, 0, '2025-10-07 10:43:46');
...
INSERT INTO `job_requisitions` (`requisition_id`, `job_id`, `requested_by`, `approval_status`, `open_date`, `close_date`) VALUES
(1, 2, 1, 'Pending', '2025-10-10', NULL),
(2, 5, 1, 'Pending', '2025-10-10', NULL),
(3, 5, 1, 'Pending', '2025-10-10', NULL),
(4, 5, 1, 'Pending', '2025-10-10', NULL),
(5, 5, 1, 'Pending', '2025-10-10', NULL),
(6, 3, 1, 'Pending', '2025-10-16', NULL);
...
INSERT INTO `login_tbl` (`id`, `email`, `password`, `account_type`, `full_name`, `google_id`, `created_at`) VALUES
(1, 'admin@hr1.com', 'admin123', 'admin', 'Administrator', NULL, '2025-10-08 03:34:59'),
(2, 'user@hr1.com', 'user123', 'user', 'user_1', NULL, '2025-10-13 14:14:41'),
(4, 'costi@h1.com', '$2y$10$ZHiKcxcfSW1xPcfcY/8nyOh.hxQc.WM7SGgICZikqBh5DB73zibPK', 'user', 'Christian Costi', NULL, '2025-10-14 02:09:30'),
(5, 'angelo@hr1.com', '$2y$10$0SXrHTb4SwxTSMVHuS4mx.X4fws3/bIubq0qLmA8KZnN2dLSR8ApS', 'user', 'Angelo Revilla', NULL, '2025-10-14 03:04:20'),
(6, 'alex@hr1.com', '$2y$10$jnpUV6gZbLmQPKQWvkjAYe.Tfiec/dHJd1P1FOrQvRYJL2PoIPqqW', 'user', 'alex Vergara', NULL, '2025-10-16 07:22:07'),
(7, 'deku@hr1.com', '$2y$10$V9LZjxrYgnvSxyQ7Gidz7OxrGHH741MqBlJGhXTo/P5kjO60QmCAy', 'user', 'Deku Midoriya', NULL, '2025-10-16 07:34:52');
...
ALTER TABLE `applicants`
  ...
  ADD KEY `fk_applicants_job` (`job_id`);
...
--
ALTER TABLE `applicants`
  ADD CONSTRAINT `fk_applicants_job` FOREIGN KEY (`job_id`) REFERENCES `jobs` (`job_id`) ON DELETE CASCADE;
...
--
ALTER TABLE `applicant_profiles`
  ADD CONSTRAINT `applicant_profiles_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `login_tbl` (`id`) ON DELETE CASCADE;
