...
<div id="sidebar" class="fixed lg:relative bg-gray-800 text-white w-64 transition-all duration-300 h-screen flex flex-col z-50">
  ...
  <nav class="flex-1 px-2 py-4 space-y-2 overflow-y-auto [&::-webkit-scrollbar]{display:none} [-ms-overflow-style:none] [scrollbar-width:none]">
    ...
    <!-- Dashboard -->
    <a href="/Atiera/admin/dashboard.php" 
    ...
    <div>
      ...
      <div class="submenu pl-8 space-y-1 hidden">
        <a href="/Atiera/admin/jobPosting.php" class="block px-3 py-1 rounded hover:bg-gray-700 text-sm">Job Postings</a>
        <a href="/Atiera/admin/interviews.php" class="block px-3 py-1 rounded hover:bg-gray-700 text-sm">Interviews</a>
    ...
    <div>
      ...
      <div class="submenu pl-8 space-y-1 hidden">
        <a href="/Atiera/admin/applicant_profile.php" class="block px-3 py-1 rounded hover:bg-gray-700 text-sm">Profiles</a>
        <a href="/Atiera/admin/tracking.php" class="block px-3 py-1 rounded hover:bg-gray-700 text-sm">Tracking</a>
        <a href="/Atiera/admin/documents.php" class="block px-3 py-1 rounded hover:bg-gray-700 text-sm">Documents</a>
      </div>
    </div>
